...
public class Jdbc_Sink {
    ...
    public static void main(String[] args) throws Exception {
        ...
        env.getCheckpointConfig().setCheckpointStorage("file:///Users/duyaoyao/Desktop/yao_tmp/state2");
        ...
        SinkFunction<Student> jdbcSink = JdbcSink.sink(
                //on duplicate key update name=?,gender=?,score=?
                ...
                new JdbcStatementBuilder<Student>() {
                    ...
                    public void accept(PreparedStatement preparedStatement, Student student) throws SQLException {
                        ...
                        preparedStatement.setDouble(7, student.getScore());
                    }
                },
        ...
        SinkFunction<Student> exactlyOnceSink = JdbcSink.exactlyOnceSink(
                ...
                new SerializableSupplier<XADataSource>() {
                    ...
                    public XADataSource get() {
                        ...
                        xaDataSource.setUrl("jdbc:mysql://bigdata001:3306/teach");
