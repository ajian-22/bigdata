 ...
 *
 */
public class End2EndEOSExercise {
    public static void main(String[] args) throws Exception {
        ...
        env.getCheckpointConfig().setCheckpointStorage("file:///Users/duyaoyao/Desktop/yao_tmp/state3");
        env.setRestartStrategy(RestartStrategies.fixedDelayRestart(Integer.MAX_VALUE,1000));

        KafkaSource<String> source = KafkaSource.<String>builder()
                .setBootstrapServers("bigdata001:9092,bigdat002:9092,bigdata003:9092")
                .setTopics("test_eos")
                .setGroupId("idea-flink-1")
       ...
       /* SinkFunction<String> jdbcSink = JdbcSink.sink(
                ...
                new JdbcConnectionOptions.JdbcConnectionOptionsBuilder()
                        .withUrl("jdbc:mysql://bigdata001:3306/teach")
                        .withUsername("root")
                        .withPassword("root123U")
                        .build()
        );*/
        ...
        SinkFunction<String> exactlyOnceSink = JdbcSink.exactlyOnceSink(
                ...
                new SerializableSupplier<XADataSource>() {
                    ...
                    public XADataSource get() {
                        ...
                        xaDataSource.setUrl("jdbc:mysql://bigdata:3306/teach");
                        xaDataSource.setUser("root");
                        xaDataSource.setPassword("root123U");
                        return xaDataSource;
                    }
                }
        );
